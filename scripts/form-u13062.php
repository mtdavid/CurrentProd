...
{
	$to = 'terri@moreturns.com,webmaster@moreturns.com';
	$subject = 'Northern Washington Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U13076"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U13068"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
