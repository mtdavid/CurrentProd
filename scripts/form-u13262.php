...
{
	$to = 'laura@moreturns.com,webmaster@moreturns.com';
	$subject = 'Northern Nevada Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U13276"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U13268"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
